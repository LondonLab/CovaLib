...
def main(name, argv):
    ...
    for i in range(len(PDB_list)):
        ...
        path = '/home/labs/londonir/dinad/Pin1/docking/'+PDBid+'/run.alk_hal.frag/poses.mol2'
        ...
        for x in range(0,499):
            ...
            outfile.append([ligand,x+1,tot_hyd_bonds,tot_unsut,tot_unsut_buried,num_bonded_lig_atms])
